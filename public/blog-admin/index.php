...
<head>
    ...
    <style>
        ...
        * { box-sizing:border-box; margin:0; padding:0; }
        ...
        .subtitle { color:#666; font-size:0.8rem; text-transform:uppercase; letter-spacing:1px; margin-bottom:30px; display:block; }
        ...
        .field input { width:100%; padding:12px 14px; border:1px solid var(--border); font-family:var(--sans); font-size:0.95rem; }
...
<body>
    <div class="login-box">
        ...
        <span class="subtitle">Our Planet Project Foundation</span>
        <h1>Blog Admin</h1>
